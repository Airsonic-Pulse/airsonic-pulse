...
This is the first release cut under the new **Airsonic-Pulse** GitHub organization. The repository was transferred from `litebito/airsonic-pulse` to `Airsonic-Pulse/airsonic-pulse` during this release cycle, and the container image namespace moved from `ghcr.io/litebito/airsonic-pulse` to `ghcr.io/airsonic-pulse/airsonic-pulse`.
